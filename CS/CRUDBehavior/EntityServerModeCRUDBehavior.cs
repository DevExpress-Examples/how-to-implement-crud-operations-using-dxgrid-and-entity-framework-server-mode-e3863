...
namespace EntityServer {
    public class EntityServerModeCRUDBehavior: Behavior<GridControl> {
        ...
        protected virtual bool CanExecuteRemoveRowCommand() {
            if(ObjectContext == null || DataSource == null || Grid == null || View == null || View.FocusedRow == null) return false;
            return true;
        }
        ...
        public void RemoveSelectedRows() {
            int[] selectedRowHandles = View.GetSelectedRowHandles();
        ...
        public void EditRow() {
            ...
            DXWindow dialog = CreateDialogWindow(View.FocusedRow, true);
