...
Namespace EntityServer
	Public Class EntityServerModeCRUDBehavior
		...
		Protected Overridable Function CanExecuteRemoveRowCommand() As Boolean
			If ObjectContext Is Nothing OrElse DataSource Is Nothing OrElse Grid Is Nothing OrElse View Is Nothing OrElse View.FocusedRow Is Nothing Then
				Return False
			End If
			Return True
		End Function
		...
		Public Sub RemoveSelectedRows()
			Dim selectedRowHandles() As Integer = View.GetSelectedRowHandles()
		...
		Protected Overridable Sub OnEditRowDialogClosed(ByVal sender As Object, ByVal e As EventArgs)
			...
			If CBool((CType(sender, DXDialog)).DialogResult) Then
				...
				DataSource.Reload()
			Else
				ObjectContext.Refresh(RefreshMode.StoreWins, View.FocusedRow)
			End If
		End Sub
